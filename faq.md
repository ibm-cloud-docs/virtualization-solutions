...
Frequently asked questions for xxx might include questions about xxx or xxx. To find all of the FAQs for {{site.data.keyword.cloud}}, see our [FAQ library](/docs/faqs).
{: shortdesc}
...
* Use "FAQ for xxx" as your title, where xxx is the short name with no trademarks.
* Name the file `faq.md` for URL readability.
...
## What should I include in my FAQ?
{: #faq-content-include}
{: faq}
