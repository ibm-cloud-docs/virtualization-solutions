...
Currently, Hyper-V on {{site.data.keyword.vpc_short}} is a Bring Your Own License (BYOL) solution. Customers must bring their own Windows&reg; Server 2025 Datacenter license to activate the bare metal server OS.
{: attention}
