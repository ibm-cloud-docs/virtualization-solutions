...
## Creating a namespace and CUDN Localnet secondary network for the green tier
{: #localnet-green-namespace}
{: step}
...
## Creating another namespace and CUDN Localnet secondary network for the red tier
{: #localnet-red-namespace}
{: step}
...
## Attaching the VLAN VNI to the cluster
{: #localnet-attach-vni}
{: step}
