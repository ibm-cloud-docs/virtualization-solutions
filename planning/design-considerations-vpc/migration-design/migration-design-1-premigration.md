...
Before beginning any migration, there are a number of tasks to be completed in order to understand what you are migrating.
{: shortdesc}
...
1. Which VMs must be re-IPed? If they use .0, .1, .2, .3, or broadcast addresses, or if you're consolidating IP ranges, you'll need to change IPs.
...
- IBM-provided licensing: IBM includes the OS license in your hourly VSI cost. Available for RHEL, Windows Server, etc.
