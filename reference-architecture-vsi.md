...
For more information about creating a design requirements heat map image, see [Design requirements heat map](/docs/architecture-framework?topic=architecture-framework-heat-map).
